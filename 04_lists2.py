...
# En este código, el usuario introduce un número para elegir el tipo de vehículo. Luego, se busca el tipo de vehículo correspondiente y la tarifa para ese tipo de vehículo en función de la opción elegida. El resto del código es el mismo que en la versión original.